...
use crate::xi::ClientToClientWriter;
...
pub fn move_up(view_id: &str, core: &dyn Peer) -> Response {
    core.send_rpc_notification(
        "edit",
        &json!({ "method": "move_up", "view_id": view_id}),
    );
    Response::Continue
}
...
pub fn move_down(view_id: &str, core: &dyn Peer) -> Response {
    core.send_rpc_notification(
        "edit",
        &json!({ "method": "move_down", "view_id": view_id}),
    );
    Response::Continue
}
...
pub fn move_left(view_id: &str, core: &dyn Peer) -> Response {
    core.send_rpc_notification(
        "edit",
        &json!({ "method": "move_left", "view_id": view_id}),
    );
    Response::Continue
}
...
pub fn yank_selection(view_id: &str, core: &dyn Peer) -> Response {
    let res =
        core.send_rpc_request("edit", &json!({ "method": "copy", "view_id": view_id}));
...
pub fn cute_selection(view_id: &str, core: &dyn Peer) -> Response {
    let cut_res =
        core.send_rpc_request("edit", &json!({ "method": "cut", "view_id": view_id}));
    if cut_res.is_err() {
...
pub fn indent(view_id: &str, core: &dyn Peer) -> Response {
    core.send_rpc_notification(
        "edit",
        &json!({ "method": "indent", "view_id": view_id}),
    );
    Response::Continue
}
...
pub fn outdent(view_id: &str, core: &dyn Peer) -> Response {
    core.send_rpc_notification(
        "edit",
        &json!({ "method": "outdent", "view_id": view_id}),
    );
    Response::Continue
}
